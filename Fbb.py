...
_my_account_ = [
    '100075307301605','100017102681223']
...
\033[1;91m         ▀▀▀ ▀░░░▀   ▀░▀ ▀░░▀ ▄▄▄█\033[1;0m
\033[1;97m--------------------------------------------------
\033[1;91m Author      : Em Kay 
\033[1;91m GitHub      : https://github.com/Emkayxd
\033[1;91m YouTube     : Only1 Em Kay
\033[1;91m Telegram    : https://t.me/emkay_smm
\033[1;91m Instagram   : Emkay_smm
\033[1;97m--------------------------------------------------
"""
...
def menu():
    ...
    elif pm in ['0','00','000','z']:jalan('%s [%s!%s] %sSee You Later Mate %s%s%s'%(H,P,H,K,O,n,P));bersih();menu_log()
...
def pengikut(token):
    ...
    try:
        ...
        try:
            ...
            print
            xox('%s [%s!%s] %sCANT FIND ANY FRIEND TRY NEW ID BRO'%(M,P,M,P))
            menu()
    ...
    def __init__(self,files):
        ...
        while True:
            ...
            if _pilih_sandi_=="":jalan('%s [%s!%s] %sINCORRECT CONTENT'%(M,P,M,P));menu()
                ...
                print('%s [%s•%s] %sEXAMPLE : %sNigeria,123456,123456654321'%(H,P,H,K,H));self.pwlist();break
